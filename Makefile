...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > evalseg/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add evalseg/VERSION HISTORY.md
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "evalseg = 'evalseg.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run evalseg'"
